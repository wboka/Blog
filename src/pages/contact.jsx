...
export default ({ data }) => (
  <Layout>
    ...
    <form
      action="https://formspree.io/wayne@bokasolutions.com"
      method="post"
      className="w-full sm:w-1/2 md:w-1/3 mx-auto"
    >
      <label htmlFor="name" required className="block font-bold">
        ...
        <input
          type="text"
          name="name"
          className="block w-full border-2 rounded"
        />
      </label>
      ...
      <input
        type="submit"
        value="Send"
        className="p-3 rounded bg-teal-700 w-full text-white"
      />
    </form>
  </Layout>
);
